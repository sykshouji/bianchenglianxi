...
7.系统运行
先打开docker服务，然后在IDEA中先后启动oj-backend、oj-front项目，系统就能够正常运行，通过访问http://localhost:5173地址登录本系统管理系统，管理员的账号为admin密码123456；教师账号为teacher密码123456；学生账号6个，分别s1到s6密码均为123456，登录后即可查看系统功能。由于使用的是千问模型，api-key改为自己的千问密钥即可调用千问模型
